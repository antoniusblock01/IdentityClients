    ...
    <div style={containerStyle}>
            ...
            {clients.map((client) => (
              <li
                ...
                style={{
                  ...clientItemStyle,
                  backgroundColor:
                    client.id === selectedClientId ? "#ffe600" : "#f4f4f5",
                  cursor: "pointer",
                }}
              >
      ...
      {selectedClient && (
        <div style={selectedClientStyle}>
          ...
          <p>
            <strong>ФИО:</strong> {selectedClient.fullName}
          </p>
          <p>
            <strong>Паспорт:</strong> {selectedClient.passport}
          </p>
          <p>
          ...
          <div style={buttonsContainerStyle}>
            ...
            {!smsRequested ? (
              ...
              <div style={smsInputContainerStyle}>
                <input
                  type="text"
      ...
      {clients && clients.length === 0 && (
        <div>
          <p style={{ color: "#1e1e1e" }}>
            Клиент с указанным номером телефона не найден.
          </p>
          <button
            onClick={() => {
              setClients(null);
